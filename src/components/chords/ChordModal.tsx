        ...
        <div className="p-4 sm:p-6">
          ...
          <Card className="mt-4">
            <CardContent className="p-3 sm:p-4">
              <h3 className="text-base font-semibold mb-2 sm:text-lg">Chord Type</h3>
        ...
        <DialogFooter className="px-4 py-3 border-t sm:px-6 sm:py-4">
          <div className="flex justify-between w-full">
            <div className="flex gap-1 sm:gap-2">
              <Button variant="secondary" size="sm" className="gap-1 text-xs sm:text-sm sm:gap-2">
            ...
            <Button variant="default" size="sm" className="gap-1 text-xs sm:text-sm sm:gap-2">
