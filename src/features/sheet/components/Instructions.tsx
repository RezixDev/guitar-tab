  ...
  return (
    <Alert>
      ...
      <AlertDescription className="space-y-2">
        <p>
          <strong>How to compose:</strong> Click on the staff to place notes. Select different
          durations from the dropdown. The playback will respect note durations and tempo settings.
        </p>
